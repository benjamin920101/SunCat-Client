...
extends Module {
    ...
    public final SliderSetting searchBarHeight = this.add(new SliderSetting("SearchBarHeight", 20, 15, 40, 1, this.searchBar::isOpen).injectTask(this::updateSearchBar));
