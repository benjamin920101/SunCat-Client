...
extends Module {
    ...
    public final StringSetting windowTitle = this.add(new StringSetting("WindowTitle", dev.idhammai.suncat.NAME, () -> this.page.is(Page.Misc) && this.titleOverride.isOpen()));
    ...
    public final StringSetting hackName = this.add(new StringSetting("Notification", "[" + dev.idhammai.suncat.NAME + "]", () -> this.page.getValue() == Page.Notification));
