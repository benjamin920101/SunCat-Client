...
import dev.suncat.asm.accessors.IContainerComponent;
import dev.suncat.core.impl.PlayerManager;
import dev.suncat.mod.gui.PeekScreen;
        ...
        block5: {
            ...
            block4: {
                if (itemStack.getItem() == Items.ENDER_CHEST) {
                    for (int i = 0; i < suncat.PLAYER.ENDERCHEST_ITEM.size(); ++i) {
                        items[i] = (ItemStack)suncat.PLAYER.ENDERCHEST_ITEM.get(i);
                    }
                    return;
                }
