...
extends Module {
    ...
    private Direction targetFacing(Vec3d vec3d) {
        ...
        for (Direction direction : Direction.values()) {
            ...
            double getDistance;
            BlockPos bp;
            if (direction == Direction.UP || direction == Direction.DOWN || !BlockUtil.isStrictDirection(bp = blockPos.offset(direction), direction.getOpposite()) || (!this.onlyHard.getValue() ? BlockUtil.canReplace(bp) || !BlockUtil.canClick(bp) : !suncat.HOLE.isHard(bp))) continue;
