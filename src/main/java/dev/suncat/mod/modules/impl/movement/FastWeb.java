...
extends Module {
    ...
    public void onUpdate(UpdateEvent event) {
        boolean bl = this.work = !FastWeb.mc.player.isOnGround() && (FastWeb.mc.options.sneakKey.isPressed() || !this.onlySneak.getValue()) && suncat.PLAYER.isInWeb((PlayerEntity)FastWeb.mc.player);
