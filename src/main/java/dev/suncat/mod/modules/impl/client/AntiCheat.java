...
import dev.suncat.mod.modules.impl.movement.MovementSync;
import dev.suncat.mod.modules.settings.enums.Placement;
...
extends Module {
    ...
    public final EnumSetting<AcMode> acMode = this.add(new EnumSetting<AcMode>("AcMode", AcMode.None, () -> this.page.is(Page.General)));
    ...
    // Rotation visualization and fix
    public final BooleanSetting visualize = this.add(new BooleanSetting("Visualize", false, () -> this.page.is(Page.Rotation)));
    public final BooleanSetting strafeFix = this.add(new BooleanSetting("StrafeFix", false, () -> this.page.is(Page.Rotation)));
