...
import dev.suncat.api.events.impl.TimerEvent;
...
extends Module {
    ...
    public void onEnable() {
        ...
        this.holePos = suncat.HOLE.getHole((float)this.range.getValue(), true, this.any.getValue(), this.up.getValue());
    }
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        if (suncat.HOLE.isDoubleHole(this.holePos) && (facing = suncat.HOLE.is3Block(this.holePos)) != null) {
