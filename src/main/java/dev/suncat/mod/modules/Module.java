 ...
 */
package dev.suncat.mod.modules;
...
import dev.suncat.mod.modules.impl.client.BaritoneModule;
import dev.suncat.mod.modules.impl.client.ClickGui;
import dev.suncat.mod.modules.impl.client.ClientSetting;
import dev.suncat.mod.modules.impl.client.ColorsModule;
...
extends Mod {
    ...
    public void enable() {
        ...
        if (suncat.MODULE != null) {
            suncat.MODULE.showToggleBanner(this, true);
        }
        this.state = true;
    ...
    public void disable() {
        ...
        if (suncat.MODULE != null) {
            suncat.MODULE.showToggleBanner(this, false);
        }
        this.state = false;
